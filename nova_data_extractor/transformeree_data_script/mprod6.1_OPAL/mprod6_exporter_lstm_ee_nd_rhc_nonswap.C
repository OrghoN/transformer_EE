...
const std::string DATA =
    "prod_caf_R24-11-18-miniprod6.1reco.c_nd_genie_AR23_20i_00_000_nonswap_rhc_nova_v08_full_v1_miniprod6-1_miniprod61respinOPAL";
...
void mprod6_exporter_lstm_ee_nd_rhc_nonswap() {
    CSVMaker maker(DATA, "dataset_lstm_ee_nd_rhc_nonswap.csv");
